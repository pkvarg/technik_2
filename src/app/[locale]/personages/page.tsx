...
const Personages = () => {
  ...
  return (
    ...
    >
      ...
      <motion.h1
        className="mt-8 mb-12 text-center text-4xl md:text-5xl font-serif text-yellow-500"
        ...
        >
          <div className="max-w-5xl mx-auto py-16 px-8">
            ...
            <motion.div className="mb-8 text-center" variants={itemVariants}>
              <h2 className="text-4xl md:text-5xl font-serif leading-tight text-yellow-500">
                {person.name}
              </h2>
              <h3 className="text-xl md:text-2xl font-serif mt-2 text-yellow-500">
                {person.title}
              </h3>
            </motion.div>

            {/* Biography with flowing text around image */}
            <motion.div className="relative text-white text-lg" variants={containerVariants}>
              <motion.div
              ...
              <div className="space-y-4 text-white text-justify text-lg first-line-indent">
